...
if(!defined('VIEW_BASEDIR'))
    define('VIEW_BASEDIR',TMVC_BASEDIR.'myapp'.DS.'views'.DS);


// this key will be used to display the main view content in a template
if(!defined('VIEW_CONTENT'))
    define('VIEW_CONTENT', 'view_content');
